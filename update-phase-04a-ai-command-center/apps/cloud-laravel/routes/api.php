...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('/updates', [UpdatePackageController::class, 'index']);
        Route::post('/updates', [UpdatePackageController::class, 'store']);
        Route::get('/updates/latest', [UpdatePackageController::class, 'latest']);
        Route::get('/updates/{updatePackage}', [UpdatePackageController::class, 'show']);
        Route::post('/updates/{updatePackage}/apply', [UpdatePackageController::class, 'apply']);
        ...
        Route::post('/ai-commands/{aiCommand}/status', [AICommandController::class, 'updateStatus']);
